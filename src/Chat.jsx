...
export default function Chat() {
	...
	return (
		<div className="rounded-full 2xl:rounded-none bg-bg1 w-10 fixed bottom-6 right-6 2xl:right-0 2xl:sticky top-headerHeight 2xl:bottom-0 2xl:w-(--chatWidth) h-10 2xl:h-complementarySidebarMaxHeight flex flex-col justify-between">
			<div
				onClick={() => setShow((o) => !o)}
			...
			>
				<div className="flex flex-col gap-2">
					...
					<Message incoming={true}>
						or sit amet consectetur adipisicing elit. Consectetur
						alias voluptates veniam delectus dolores corrupti! Sint
						amet facilis distinctio pariatur officia illum
						voluptatibus ex illo blanditiis neque ab, nobis in.
						Lorem ipsum dolor sit amet consectetur adipisicing elit.
						Consectetur alias voluptates veniam delectus dolores
						corrupti! Sint amet facilis distinctio pariatur officia
						illum voluptatur adipisicing elit. Consectetur alias
						rupti! Sint amet facilis distinctio pariatur officia
