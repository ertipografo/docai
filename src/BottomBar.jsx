      ...
      <div className="px-padding-sm absolute bottom-padding-sm left-1/2 -translate-x-1/2 w-full max-w-md">
        <div className="flex h-header items-center px-padding-sm rounded-panel bg-bg-dark text-text-dark">
          ...
          <div className="flex-1 flexer">
            <div className="h-btn flexer rounded-button bg-action-dark min-w-14 text-xs font-semibold">
              1 / 34
            </div>
          </div>
          <div className="flex-1 flex items-center justify-end relative">
            <div
              ...
              className="h-btn cursor-pointer w-btn rounded-button bg-action-primary flexer"
            >
