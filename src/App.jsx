	...
	return (
		<div className="flex flex-col h-screen overflow-hidden text-base">
			...
			<div className="flex-1 flex overflow-hidden">
				<div className="w-(--headerHeight) hidden lg:block bg-gray-900 relative z-50">
				...
				<div className="flex flex-col lg:flex-row flex-1 overflow-auto">
					<div
						...
						} lg:w-(--sidebarWidth) transition-all lg:border-r borderColor bgPrimary relative z-40`}
					>
					...
					<div className="flex-1 overflow-visible lg:overflow-auto">
						<div className="flex flex-col bgSecondary relative min-h-full">
							{/* <div className="flex bgPrimary border-b borderColor lg:hidden fixed z-30 top-(--headerHeight) left-0 right-0">
							...
							<div className="flex flex-col relative flex-1 bgPrimary">
								{/* <div className="bgSecondary sticky top-24 lg:-top-2 w-full flex flex-col z-30 px-4 pt-4">
									<div
